...
$sql = "SELECT id, slug, summary, social_sharing_image FROM webdev_blogs 
        WHERE category = 'scm' AND blog_status = 'published' 
        ORDER BY id DESC 
...
$totalBlogsResult = $conn->query("SELECT COUNT(*) AS total FROM webdev_blogs WHERE category = 'scm' AND blog_status = 'published'");
