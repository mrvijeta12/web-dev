...
$sql = "SELECT id, slug, summary, social_sharing_image FROM webdev_blogs 
        WHERE category = 'drupal-developer' AND blog_status = 'published' 
        ORDER BY id DESC 
...
$totalBlogsResult = $conn->query("SELECT COUNT(*) AS total FROM webdev_blogs WHERE category = 'drupal-developer' AND blog_status = 'published'");
                ...
                <section class="work-wrapper-child">
                    ...
                    <section class="work-child">
                        ...
                        <p>Providing ongoing maintenance and support is essential for Drupal projects. Developers ensure that
                            ...
                            This proactive approach helps prevent vulnerabilities, enhances user experience, and ensures the long-term
                            stability of Drupal applications.</p>
                    </section>
