...
$sql = "SELECT id, slug, summary, social_sharing_image FROM webdev_blogs 
        WHERE category = 'html-developer' AND blog_status = 'published' 
        ORDER BY id DESC 
...
$totalBlogsResult = $conn->query("SELECT COUNT(*) AS total FROM webdev_blogs WHERE category = 'html-developer' AND blog_status = 'published'");
                ...
                <section class="work-wrapper-child">
                    ...
                    <section class="work-child" data-aos="fade-left" data-aos-duration="1000">
                        ...
                        <p>HTML developers offer ongoing maintenance and support for websites post-launch. This includes
                            ...
                            they ensure optimal performance and user engagement, preventing issues that could affect the site’s
                            reliability and reputation.</p>
                    </section>
