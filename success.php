    ...
    <div>
        ...
        <div class="wrapper" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="success_hero">
                <h1 data-aos="zoom-in" data-aos-duration="2500">Our Success Stories</h1>
                <h2 data-aos="zoom-in" data-aos-duration="2500">See How We've Helped Businesses Grow</h2>
            ...
            <div class=" about_choose_container">
                <div class="about_choose_content ">
                    ...
                    <div class="about_choose_data" data-aos="zoom-in" data-aos-duration="1500">
                        ...
                        <p>Our success is built on innovation, collaboration, and delivering impactful IT solutions. By solving complex challenges and empowering businesses to thrive, we've earned the trust of clients worldwide. Each achievement fuels our commitment to excellence, driving continuous growth and transformative results in the ever-evolving digital landscape.</p>
                    </div>
                </div>
            ...
            <div class="choose_container">
                <div class="choose_content check">
                    <div class="choose_image" data-aos="fade-up-right" data-aos-duration="1500">
                        <img src="images/campaign-creators-qCi_MzVODoU-unsplash.jpg" alt="choose us">
                    </div>
            ...
            <div class="about_container">
                <h2 data-aos="zoom-in" data-aos-duration="1500">Industry Specific Success</h2>
            ...
            <section class="industry-success-wrapper">
                <section class="industry-success-childs industry-child">
                    <section class="industry-success-childs-image">
                        <img src="images/10.jpg" alt="">
                    </section>
                    <section class="industry-success-childs-text">
                        <h2>healthcare industry</h2>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi, culpa. Sapiente impedit explicabo et possimus!</p>
                    </section>
                </section>
                <section class="industry-success-childs industry-child">
                    <section class="industry-success-childs-image">
            ...
            <section class="testimonial_wrapper">
                <h1 data-aos="zoom-in" data-aos-duration="1500">What Our Clients Say</h1>
