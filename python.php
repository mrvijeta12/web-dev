...
$sql = "SELECT id, slug, summary, social_sharing_image FROM webdev_blogs 
        WHERE category = 'python' AND blog_status = 'published' 
        ORDER BY id DESC 
...
$totalBlogsResult = $conn->query("SELECT COUNT(*) AS total FROM webdev_blogs WHERE category = 'python' AND blog_status = 'published'");
    ...
    <div>
        ...
        <div class="wrapper">
            ...
            <div class="image-wrapper">
                <img src="images/python-development-hero.jpg"></img>
            </div>
