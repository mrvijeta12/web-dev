...
$sql = "SELECT id, slug, summary, social_sharing_image FROM webdev_blogs 
        WHERE category = 'drupal' AND blog_status = 'published' 
        ORDER BY id DESC 
...
$totalBlogsResult = $conn->query("SELECT COUNT(*) AS total FROM webdev_blogs WHERE category = 'drupal' AND blog_status = 'published'");
    ...
    <div>
        ...
        <div class="wrapper" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="image-wrapper">
                <img src="images/drupal-development-hero.jpg"></img>
            </div>
